...
const STEPS = [
  ...
  },
  {
    ...
    hint: "This becomes your logbook's title throughout the app.",
    placeholder: 'e.g. Internship Log, Work Journal, Freelance Diary',
  },
  {
    id: 'organization',
    field: 'organization',
  ...
  },
  {
    ...
    number: '04',
    question: "What's your usual work location?",
    hint: 'This pre-fills the location field on every new entry.',
    placeholder: 'e.g. Office, Remote, Campus Library',
  },
]
